...
const baseConfig = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '★ σвιтσ-кυη ★;𝗢𝗕𝗜𝗧𝗢-𝗕𝗢𝗧𝗭𝗭;https://cdn.ironman.my.id/i/sdhlnw.jpg' : process.env.AUDIO_DATA,
